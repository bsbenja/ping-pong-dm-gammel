...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Klubber</h5>",
...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Danmarkskort</h5>",
"<i style=font-size:70%>",
...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Aldersgrupper</h5>",
"<i style=font-size:70%>",
...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Køn</h5>",
"<i style=font-size:70%>",
...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Gentilmeldinger</h5>",
"<i style=font-size:70%>",
...
#| output: asis
cat(paste0(
"<i style=font-size:70%>Gentilmeldinger gælder fra og med ", distinct(filter(tbl0_join_alle, k_2021_eller_senere == tbl0_unik$k_2021_eller_senere), min(k_eventår)), "</i>"))
```
...
#| output: asis
cat(paste0(
"<h5 style=font-weight:bold>Deltagere</h5>",
"<i style=font-size:70%>",
