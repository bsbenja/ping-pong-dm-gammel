...
knitr::raw_html(paste0(
	'<p style="text-align:center;width:36em;max-width:100%">
...
"text-align:center;font-weight:bold;","font-size:150%;width:24em;",
...
"<br>",
"<i style=font-weight:normal;font-size:60%>", var_indbydelse$k_event_ping_pong_år, "</i></a>",
"<br><br>",
"![](Filer/Event/", var_indbydelse$k_eventår,
"/Indbydelsesplakat-DM-i-Ping-Pong-", var_indbydelse$k_eventår,
".png){width=36em}",
"<br>",
"<figcaption>",
...
tbl0_join_alle %>%
	...
	mutate(k_billettype = paste0("<a style=color:#000000;text-decoration:none href=indbydelse-tilmelding.qmd#", gsub(" ", "-", sub(".*? ", "", tolower(ifelse(grepl("Ping Pong", k_billettype), paste(k_billettype, var_indbydelse$k_eventår), as.character(k_billettype))))), ">", k_ikon_billettype, sub(".*? ", " ", ifelse(grepl("Ping Pong", k_billettype), paste(k_billettype, var_indbydelse$k_eventår), as.character(k_billettype))), "</a>")) %>%
	mutate(k_billetpris = paste("kr.", format(k_billetpris, big.mark = "."), var_ikon$k_penge)) %>%
...
Fra kl. 19 vil der være stor fest! Flere detaljer kommer senere - Ikke desto mindre kan der ses frem til et brag af en fest, hvor det forventes, at der vil være mad, nogle valgfrie drikkevarer samt fælles bustransport ind til Aarhus C senere på aftenen inkluderet i prisen.
